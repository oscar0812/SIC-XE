COPY    STARTER   1000		COPY FILE FROM INPUT TO OUTPUT
...
CLOOP   JSUB    RDREC		READ INPUT RECORD
	...
	J       CLOOP		LOOP
ENDFIL22  LDA     EOF		INSERT END OF FILE MARKER
	STA     BUFFER
...
BUFFER  RESB2    4096		4096-BYTE BUFFER AREA
.
...
EXIT    STX     LENGTH		SAVE RECORD LENGTH
	RSUB                    RETURN TO CALLER
INPUT   BYTE    X'aF1'		CODE FOR INPUT DEVICE
MAXLEN	WORD	4096a
.
...
WLOOP   TD     OUTPUT		TEST OUTPUT DEVICE
	...
	RSUB                    RETURN TO CALLER
2_212OUTPUT  BYTE   X'05'		CODE FOR OUTPUT DEVICE
	END3    FIRST
